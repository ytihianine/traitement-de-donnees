...
def tasks_oad_indicateurs():
    ...
    accessibilite = create_task(
        ...
        steps=[
            ETLStep(
                fn=process.process_accessibilite,
            )
        ],
    ...
    accessibilite_detail = create_task(
        ...
        steps=[
            ETLStep(
                fn=process.process_accessibilite_detail,
            )
        ],
        # use_required_cols=True,
    )
    ...
    deet_energie_ges = create_task(
        ...
        steps=[
            ETLStep(
                fn=process.process_deet_energie,
            )
        ],
        # use_required_cols=True,
    )
    ...
    exploitation = create_task(
        ...
        steps=[
            ETLStep(
                fn=process.process_exploitation,
            )
        ],
        # use_required_cols=True,
    )
    ...
    proprietaire = create_task(
        ...
        steps=[
            ETLStep(
                fn=process.process_proprietaire,
            )
        ],
        # use_required_cols=True,
    )
    reglementation = create_task(
        ...
        steps=[
            ETLStep(
                fn=process.process_reglementation,
            )
        ],
        # use_required_cols=True,
    )
    ...
    localisation = create_task(
        ...
        steps=[
            ETLStep(
                fn=process.process_localisation,
            )
        ],
        # use_required_cols=False,
    )
