...
from src.infra.file_handling.base import FSInterface, FileMetadata
from src.infra.file_handling.exceptions import FileNotFoundError
...
class TestConcreteHandlerOperations:
    ...
    def test_move(self) -> None:
        ...
        assert handler.exists("src.txt") is False
    ...
    def test_copy(self) -> None:
        ...
        assert handler.exists("src.txt") is True
        assert handler.read("dst.txt").read() == b"data"
