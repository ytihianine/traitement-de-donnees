...
storage_options = {
    "quota_par_entite": SelecteurStorageOptions(
        load_strategy=LoadStrategy.FULL_LOAD, keep_file_id_col=False
    ),
    "experimentateurs": SelecteurStorageOptions(
        load_strategy=LoadStrategy.FULL_LOAD, keep_file_id_col=False
    ),
    # Questionnaire 1
    "questionnaire_1": SelecteurStorageOptions(
        load_strategy=LoadStrategy.FULL_LOAD, keep_file_id_col=False
    ),
    "questionnaire_1_cas_usage": SelecteurStorageOptions(
        load_strategy=LoadStrategy.FULL_LOAD, tbl_order=5, keep_file_id_col=False
    ),
    "questionnaire_1_besoins_accompagnement": SelecteurStorageOptions(
        load_strategy=LoadStrategy.FULL_LOAD, tbl_order=5, keep_file_id_col=False
    ),
    # Questionnaire 2
    "questionnaire_2": SelecteurStorageOptions(
        load_strategy=LoadStrategy.FULL_LOAD, keep_file_id_col=False
    ),
    ...
    # Questionnaire_3
    "questionnaire_3": SelecteurStorageOptions(
        load_strategy=LoadStrategy.FULL_LOAD, keep_file_id_col=False
    ),
