...
storage_options = {
    ...
    "correspondant": SelecteurStorageOptions(tbl_order=5),
    "correspondant_competence_particuliere": SelecteurStorageOptions(tbl_order=6),
    "correspondant_connaissance_communaute": SelecteurStorageOptions(tbl_order=6),
    "correspondant_profil": SelecteurStorageOptions(tbl_order=6),
