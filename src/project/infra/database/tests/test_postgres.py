...
from project.infra.database.postgres import PgAdapter
...
class TestPgAdapterExecute:
    @patch("project.infra.database.postgres.psycopg2")
...
class TestPgAdapterFetchDf:
    @patch("project.infra.database.postgres.pd.read_sql")
    @patch("project.infra.database.postgres.create_engine")
